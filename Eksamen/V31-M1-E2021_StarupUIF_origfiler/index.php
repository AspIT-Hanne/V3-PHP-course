...
<body>
    ...
    <main>
        ...
        <form method="post">
            <label for="eventKategori">Vælg kategori</label>
            ...
            <input type="submit" name="katVaelger" value="Vælg">
        </form>
        ...
        <article>
                ...
                <img src="img/GaaturTunneldal.jpg">
            ...
            <article>
                ...
                <img src="img/VegetarKokkeskole.jpg">
            ...
            <article>
                ...
                <img src="img/Serie1haandbold.jpg">
            ...
            <article>
                ...
                <img src="img/ForedragMortenKristiansen.jpg">
